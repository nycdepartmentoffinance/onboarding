# adapted from Thomas Bury's script here: https://github.com/ThomasBury/conda-git-pip-proxy
...
if ($component -eq "all" -or $component -eq "pip" -or $component -eq "git-pip" -or $component -eq "conda-pip") {
    ...
    pip config set global.trusted-host "pypi.python.org global.trusted-host pypi.org global.trusted-host files.pythonhosted.org github.com"
}
